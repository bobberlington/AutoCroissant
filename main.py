...
async def slash_query_ability(interaction: Interaction,
                              ...
                              filter_raids: Optional[bool] = False):
    if howmany:
...
async def slash_del_alias(interaction: Interaction,
                          alias: str):
...
async def slash_frankenstein(interaction: Interaction,
                             cards: str):
    await interaction.response.defer()
...
async def slash_export_abilities(interaction: Interaction,
                                 only_ability: Optional[bool] = True,
...
async def slash_update_metadata(interaction: Interaction,
                                query: str = "",
...
@app_commands.describe(
    query='The card to edit the metadata for.')
async def slash_query_stats(interaction: Interaction,
                            query: str = ""):
    await interaction.response.defer()
...
async def on_message(message: Message):
    ...
    # This will clear ALL slash commands globally/locally.
    # Use this when we remove slash commands.
